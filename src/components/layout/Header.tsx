...
const solutions = [
  ...
  { name: 'Policies', description: "Your customers' data will be safe and secure.", href: '#', icon: ShieldCheckIcon },
  {
    name: 'Employment',
      ...
      <div className=" max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
              <span className="sr-only">Dream Team</span>
              <img
                className="h-8 w-auto sm:h-10"
                src="https://i.imgur.com/TsWAjq0.png"
                alt=""
              />
            </a>
          </div>
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-teal-900 focus:outline-none'
                    )}
                  >
            ...
            <Link href="/publication" className="text-base font-medium text-gray-500 hover:text-teal-900">
              Our Pulications
            </Link>
            <Link href="/contact" className="text-base font-medium text-gray-500 hover:text-teal-900">
              Contact Us
            </Link>
          </Popover.Group>
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a href="#" className="whitespace-nowrap text-base font-medium text-teal-500 hover:text-teal-900">
              Sign in
            </a>
            <a
              href="#"
